<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CoverTheCrop.aspx.cs" Inherits="Auto_Farm_Ops.MyFarm.Pages.CoverTheCrop" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>COVER THE CROP</title>
     <style>
body { 
  display: grid;
  grid-template-areas: 
        ...
        <table>  
            <tr>  <td> </td>
                <td colspan="8" style="text-align: center; vertical-align: Top">  
                    <asp:Label ID="Label1" runat="server" Font-Bold="True" Font-Size="XX-Large" Font-Underline="True" Text="CoverTheCrop">Cover The Crop:</asp:Label>  
                </td>  
            </tr>  
            <tr>
            ...
            <tr>  
                ...
                <td style="text-align: center">  
                    <asp:Label ID="Label2" runat="server" Font-Size="X-Large" Text="Cover On">Click Here to Cover On:</asp:Label>  
                </td>  
                <td style="text-align: center">  
                     <asp:Button ID="Button2" runat="server" BorderStyle="None" Font-Size="X-Large"  Text="Fleece On" Height="49px" />
                </td>  
                <td> </td>  
                <td> </td>  
                <td> </td>  
            ...
            <tr>  
                <td> </td>  
                <td style="text-align: center">  
                    <asp:Label ID="Label3" runat="server" Font-Size="X-Large" Text="Cover Off">Click Here to Cover Off:</asp:Label>  
                </td>  
                <td style="text-align: center">  
                    <asp:Button ID="Button1" runat="server" BorderStyle="None" Font-Size="X-Large"  Text="Fleece Off" Height="49px" /> 
                </td>  
                <td> </td>  
                <td> </td>  
                <td> </td>  
