<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CurrentCropDetails.aspx.cs" Inherits="Auto_Farm_Ops.MyFarm.Pages.CurrentCropDetails" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>CURRRENT CROP DETAILS</title>
     <style>
body { 
  display: grid;
  grid-template-areas: 
        ...
        <table>  
            <tr>  <td> </td>
                <td colspan="8" style="text-align: center; vertical-align: Top">  
                    <asp:Label ID="Label1" runat="server" Font-Bold="True" Font-Size="XX-Large" Font-Underline="True" Text="CropDetails">Current Crop Details:</asp:Label>  
                </td>  
            </tr>  
            <tr>  
                <td> </td>  
            ...
            <tr>  
                <td> </td>  
                <td style="text-align: center">  
                    <asp:Label ID="Label3" runat="server" Font-Size="X-Large" Text="Required Temperature:">Required Temperature:</asp:Label>  
                </td>  
                <td style="text-align: center">  
            ...
            <tr>  
                <td> </td>  
                 <td style="text-align: center">  
                    <asp:Label ID="Label5" runat="server" Font-Size="X-Large" Text="Required Humidity">Required Humidity:</asp:Label>  
                </td>  
                <td style="text-align: center">  
            ...
            <tr>  
                <td> </td>  
                <td style="text-align: center">  
                    <asp:Label ID="Label6" runat="server" Font-Size="X-Large" Text="NPK Level">NPK Level:</asp:Label>  
                </td>  
                <td style="text-align: center">  
            ...
            <tr>  
                <td> </td>  
               <td style="text-align: center">  
                    <asp:Label ID="Label4" runat="server" Font-Size="X-Large" Text="Water Requirement">Water Requirement ml:</asp:Label>  
                </td>  
                <td style="text-align: center">  
                    <asp:TextBox ID="TextBox5" runat="server" Font-Size="X-Large" TextMode="Password"></asp:TextBox>  
                </td>  
            ...
            <tr>  
                <td> </td>  
               <td style="text-align: center">  
                    <asp:Label ID="Label7" runat="server" Font-Size="X-Large" Text="Wind Flow">Wind Flow Km/s:</asp:Label>  
                </td>  
                <td style="text-align: center">  
                    <asp:TextBox ID="TextBox6" runat="server" Font-Size="X-Large" TextMode="Password"></asp:TextBox>  
                </td>  
            ...
            <tr>  
                <td> </td>  
               <td style="text-align: center">  
                    <asp:Label ID="Label8" runat="server" Font-Size="X-Large" Text="Expected time for complete grow">Approximate days to Grow:</asp:Label>  
                </td>  
                <td style="text-align: center">  
            ...
            <tr>  
                ...
                <td></td>
                    ...
                    <td class="submit" style="text-align:center"><asp:Button ID="Button1" runat="server" BorderStyle="None" Font-Size="X-Large"  Text="SUBMIT DETAILS" Height="49px"/>
                </td> 
                <td></td>
                </tr>
            <tr>
                <td><asp:Label ID="Label9" runat="server" Font-Size="X-Large"></asp:Label></td>
            </tr>
             <tr>
                <td><asp:Label ID="Label10" runat="server" Font-Size="X-Large"></asp:Label></td>
            </tr>
             <tr>
